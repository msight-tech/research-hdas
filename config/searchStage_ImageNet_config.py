...
class SearchStageImageNetConfig(BaseConfig):
    def build_parser(self):
        parser = get_parser("Search Dag config on cifar10 for ImageNet")
        ...
        parser.add_argument('--layers', type=int, default=14, help='# of layers')  # 20 layers
