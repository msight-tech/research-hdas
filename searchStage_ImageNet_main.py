...
from config.searchStage_ImageNet_config import SearchStageImageNetConfig
...
def run_task(config):
    ...
    logger.info("Final Best Genotype = {}".format(best_marco))


def main():
    config = SearchStageImageNetConfig()
    run_task(config)
